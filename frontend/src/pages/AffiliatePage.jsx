...
export default function AffiliatePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Affiliate / Referral</h1>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="card text-center">
          ...
          <p className="text-2xl font-bold text-green-600">Rp {Number(affiliate?.total_commission || 0).toLocaleString('id-ID')}</p>
        </div>
        <div className="card text-center">
          <p className="text-sm text-gray-500">Rate Komisi</p>
      ...
      <div className="card mb-6">
        ...
        <p className="text-xs text-gray-500 mt-2">Kode referral: <strong>{user?.referral_code}</strong></p>
      </div>
